    ...
    <section class="bg-[url('/public/IMAGES/bg2.png')] bg-center bg-cover" id="aboutus">
        <div class="container mt-14 mx-auto py-16 px-6  sm:px-6 lg:px-8 ">
            <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
                <div class="max-w-lg">
                    <h2
                        class="text-3xl font-bold text-gray-800 mb-8 italic bg-gradient-to-l from-transparent to-green-400 px-2">
                        About us</h2>
        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <h3
                        class="text-2xl font-semibold text-gray-800 mb-4 bg-gradient-to-l from-transparent to-green-400 px-1">
                        Mission</h3>
                    <p class="text-gray-600 text-justify">To become the Philippines Pharmaceutical Distribution Company
                        of Choice by providing communities with a constant supply of top-quality medicines at reasonable
                        prices and by serving them with our compassionate, professional, and talented employees.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <h3
                        class="text-2xl font-semibold text-gray-800 mb-4 bg-gradient-to-l from-transparent to-green-400 px-1">
                        Vision</h3>
                    <p class="text-gray-600 text-justify">To lead the industry in pharmaceutical distribution by
                        delivering exceptional medical products and supplies, a steadfast focus on customers' needs and
                        top-notch customer service for the wellbeing of all.</p>
                </div>
            ...
            <div class="bg-white mt-6 p-6 rounded-lg shadow-lg ">
                ...
                <p class="text-gray-800 text-justify mb-2"><span class="font-bold">Integrity</span> - doing the right
                    thing right regardless of the situation; being honest even if no one is watching.</p>
                <p class="text-gray-800 text-justify mb-2"><span class="font-bold">Entreprenerial Spirit</span> - we
                    seek and pursue opportunities that is best for the company or having the sense of ownership by
                    optimizing and finding cost-efficient use of company resource and always thingking about the
                    company's long-term welfare.</p>
                <p class="text-gray-800 text-justify mb-2"><span class="font-bold">Professionalism</span> - work ethics
                    should be anchored on discipline, reliability and performance.</p>
                <p class="text-gray-800 text-justify mb-2"><span class="font-bold">Service Oriented</span> - delivering
                    sincere care or services to our employees, co-workers, business partners and society we live in.</p>
                <p class="text-gray-800 text-justify mb-2"><span class="font-bold">Teamwork</span> - working together as
                    a team or always thinking of the welfare of the whole team.</p>
